...
export default function CreateComponent(props) {
  ...
  return (
      ...
      >
        <div
            className={`start-page-text start-page-large-text ${displayInstall ? 'start-page-main-details-visible' : ''}`}>
          1. Visit OpenAI
        </div>
        <div
            className={`start-page-text start-page-small-text ${displayInstall ? 'start-page-main-details-visible' : ''}`}>
          Visit {' '}
          <a href="https://platform.openai.com/api-keys" target="_blank">
            API key dashboard
          </a>{' '}
